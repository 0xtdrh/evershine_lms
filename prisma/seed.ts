...
async function main() {
  ...
  const studentSeeds = [
    {
      email: 'student1@technova.local',
      regNumber: 'TN/2026/0001',
      firstName: 'Ali',
      lastName: 'Hassan',
      fullNameAr: 'علي حسن محمد إبراهيم',
      fatherName: 'Mohamed Hassan',
      dob: new Date('2015-05-12'),
      phone: '+20-100-2222001',
    },
    {
      email: 'student2@technova.local',
      regNumber: 'TN/2026/0002',
      firstName: 'Youssef',
      lastName: 'Adel',
      fullNameAr: 'يوسف عادل طارق شعبان',
      fatherName: 'Tarek Adel',
      dob: new Date('2013-08-22'),
      phone: '+20-100-2222002',
    },
    {
      email: 'student3@technova.local',
      regNumber: 'TN/2026/0003',
      firstName: 'Bilal',
      lastName: 'Ahmed',
      fullNameAr: 'بلال أحمد رشيد سالم',
      fatherName: 'Rashid Ahmed',
      dob: new Date('2011-01-30'),
      phone: '+20-100-2222003',
    },
  ]
